...
<head>
	...
	<title>Nidella Rest | Room Manager Login</title>
</head>
<body>
...
<br>
	...
	<div class="wrapper">
		<form class="form-signin" action="roomManagerLogin.php" method="POST">
			...
			<input type="Email" name="mEmail" class="form-control" id="mEmain" placeholder="Manager Email"  autofocus="" required/>
			
			<label for="inputMpassword">Manager Email</label>
			<input type="Password" name="mPassword" class="form-control" id="mPassword" placeholder="Manager Password" required />
			<!-- <br> -->
			<label class="checkbox">
				<input type="checkbox" value="remember-me" id="adminRememberMe" name="adminRememberMe"/>
				Remember Me
			</label>
			<button name="mLogin" id="mLogin" class="btn btn-lg btn-primary btn-block" href="#" style="background-color: #142C90;">Sign in</button>		</form>
	</div>
<br>
<br>
<!--start footer-->
