			...
			<nav class="navbar navbar-expand-sm navbar-dark">
                ...
                <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarNav" aria-controls="navbarNav" aria-expanded="false" aria-label="Toggle navigation">
                    ...
                    <nav class="menu menu--iris">
						<ul class="navbar-nav">
							<li class="menu__item--current"><a href="#" class="menu__link ">Booking Rooms</a></li>
							
							<li class="menu__item"><a href="#" class="menu__link ">Chicked Customers</a></li>
							
							<li class="menu__item"><a href="#" class="menu__link ">Manager Profile</a></li>
							...
							<li class="nav-item dropdown menu__item">
								...
								<div class="dropdown-menu" aria-labelledby="navbarDropdown">
									...
									<a class="dropdown-item" href="#">Manager Details</a>
								</div>
      						</li>
						</ul>
					</nav>
...
<br>
  ...
  <button type="submit" class="btn btn-lg btn-primary btn-block"> <a href="index.php">CheckOut Room</button>
</form>
	</div>
